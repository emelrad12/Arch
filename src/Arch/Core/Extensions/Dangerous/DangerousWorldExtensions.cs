...
public static class DangerousWorldExtensions
{
    ...
    public static EntityDataArrayProxy GetEntityDataArray(this World world)
    {
    ...
    public static void SetEntityDataArray(this World world, EntityDataArrayProxy slots)
    {
    ...
    public static void SetArchetypes(this World world, List<Archetype> archetypes)
    {
        ...
        foreach (var archetype in archetypes)
        {
            ...
            world.Capacity += archetype.EntitiesPerChunk * 1;
        }
    }
